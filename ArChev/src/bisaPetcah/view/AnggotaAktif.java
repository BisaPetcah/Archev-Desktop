 ...
 * @author bisa_petcah
 */
public class AnggotaAktif extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAnggotaAktif.setBackground(new java.awt.Color(248, 164, 0));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bisaPetcah/images/tab/anggota_aktif.png"))); // NOI18N
    ...
    private void btnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariActionPerformed
        ...
        if (edtCari.getText().isBlank()) {
            ...
            ArrayList<Member> dataPelanggan = memberService.where("m.nama LIKE '%" + edtCari.getText() + "%' AND status = 'Aktif'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnggotaAktif.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnggotaAktif().setVisible(true);
            }
        });
    }
