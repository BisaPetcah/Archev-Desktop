 ...
 * @author bisa_petcah
 */
public class AnggotaDivisiAndroid extends javax.swing.JFrame {
    ...
    public void tampilAll() {
        int i = 1;
        ArrayList<Member> dataAnggota = memberService.where("d.id = 2");
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bisaPetcah/images/tab/divisi/divisi_android.png"))); // NOI18N
    ...
    private void btnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariActionPerformed
        ...
        if (edtCari.getText().isBlank()) {
            ...
            ArrayList<Member> dataPelanggan = memberService.where("m.nama LIKE '%" + edtCari.getText() + "%' AND d.id = 2");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnggotaDivisiAndroid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnggotaDivisiAndroid().setVisible(true);
            }
        });
    }
